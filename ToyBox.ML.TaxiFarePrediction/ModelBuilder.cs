...
namespace ToyBox.ML.TaxiFarePrediction
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\Git\404Vector\ToyBox\ToyBox.ML.TaxiFarePrediction\Dataset\taxi-fare-train.csv";
        private static string MODEL_FILEPATH = @"C:\Users\HYC korea\AppData\Local\Temp\MLVSTools\ToyBoxML\ToyBoxML.Model\MLModel.zip";
        ...
        {
            string fullPath = Path.Combine(System.Environment.CurrentDirectory, relativePath);
